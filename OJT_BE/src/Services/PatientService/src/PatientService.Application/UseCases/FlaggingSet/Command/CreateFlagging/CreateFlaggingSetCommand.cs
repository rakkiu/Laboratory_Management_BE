...
namespace PatientService.Application.UseCases.FlaggingSet.Command
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class CreateFlaggingSetCommand : IRequest<FlaggingSetConfigDto>, IAuditableCommand
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public Guid? GetEntityId() => null; // ID chưa tồn tại khi tạo mới
    }
}
