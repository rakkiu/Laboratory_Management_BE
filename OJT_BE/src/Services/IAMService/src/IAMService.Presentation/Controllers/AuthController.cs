...
using IAMService.Application.Models.ChangePassword;
...
{
    /// <summary>
    /// Authentication controller for login, logout, and token refresh operations
    /// </summary>
    [ApiController]
    [Route("api/auth")]
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<LoginResultDto>>> Refresh([FromBody] RefreshTokenRequest request)
        {
